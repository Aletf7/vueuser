      ...
      <div class="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
        ...
        >
          <div class="h-20 w-20 rounded-full border overflow-hidden">
            <img src="../assets/god.png" alt="Avatar" class="h-full w-full" />
          </div>
          <div class="text-sm font-semibold mt-2">Keanu Reeves.</div>
          <div class="text-xs text-gray-500">Matrix God</div>
